"""
CSV Ingestion parser for CryptoTrace AI.
"""
import pandas as pd
...
def load_csv(filepath: str) -> Tuple[pd.DataFrame, IngestionReport]:
    """Parse CSV of transaction records into canonical pandas DataFrame."""
